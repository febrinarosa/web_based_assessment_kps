...
<body>
<h4><center>Input Nilai Pretest</center></h4>
...
$q=mysqli_query($koneksi,"SELECT * FROM `pretest_kerapatan` WHERE nimkelas='$nim'");
...
<form action="" method="post">
  ...
  width="100%" id="dtHorizontalExample">
	...
	$sql= "INSERT INTO nilai_pretest VALUES('$nim','$p1','$p2','$p3','$p4','$p5','$nilai')";

		if (mysqli_query($koneksi, $sql)){
			echo'<script language="javascript">alert("Terima kasih, data Anda berhasil disimpan");document.location="lihatpretest.php";</script>';
		}
		else
		{
