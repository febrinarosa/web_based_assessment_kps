...
<link rel="stylesheet" href = "style.css">
    <h4 align="center">LEMBAR PENILAIAN POST-TEST MAHASISWA</h4>
<h5 align="center">KERAPATAN</h5>
<hr>
<p><strong>Petunjuk!</strong></p>
<p align="justify">Untuk memberi nilai mahasiswa dapat dilakukan dengan meng-klik nama pada daftar tabel di bawah ini. Pengguna akan dibawa ke laman jawaban post-test mahasiswa. Silahkan beri skor per jawaban kemudian submit untuk menyimpan nilai.<strong></strong></p>
</div>
...
$q=mysqli_query($koneksi,'SELECT postest_kerapatan.nama,postest_kerapatan.nimkelas,nilai_postest.p1,nilai_postest.p2,nilai_postest.p3,nilai_postest.p4,nilai_postest.p5,nilai_postest.nilai FROM postest_kerapatan LEFT JOIN nilai_postest ON postest_kerapatan.nimkelas=nilai_postest.nimkelas');
  ...
  width="100%" id="dtHorizontalExample">
	...
	$no = 1;
            while($data = mysqli_fetch_array($q)){
				...
				$nim=$data['nimkelas'];
				$qq=mysqli_query($koneksi,"SELECT * FROM nilai_postest WHERE nimkelas='$nim'");
        	    ...
        	    if ($count>0){
        	        ...
        	        echo "<td><a href = 'inputnilai_postest_fix.php?nim=".$data['nimkelas']."'>".$data['nama']."</a></td>";
        	    }
...
?>
			     ...
			     <div>
        <a href="unduh_postest.php"><button type="button" class="btn btn-success float-left">
          Unduh Data
