...
<div class="container-fluid">
  ...
  <li class="nav-item dropdown">
    ...
    <div class="jumbotron">
		...
		<div><a href="https://fisika.fkip.unja.ac.id/fisikadasar1/chartindividual.php"><button type="button" class="btn btn-outline-primary float-right">Lihat Grafik Siswa</button></a></div>
		<div><a href="excel.php"><button type="button" class="btn btn-outline-primary float-right">Lihat Grafik Kelas</button></a></div>
<p class=MsoNormal>&nbsp;</p>
<p class=MsoNormal>&nbsp;</p>
	<title>Grafik KPS</title>
