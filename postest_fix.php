...
<p align="center"><strong>LEMBAR POST TEST MAHASISWA </strong></p>
<p align="center"><strong>KERAPATAN</strong></p>
<p><strong><b>PETUNJUK</b> </strong></p>
<p align="justify">Isi data Anda dan jawablah pertanyaan berikut setelah menyelesaikan praktikum kerapatan! </p>
			<table class="table">
			  <tr>
...
<tr>
    ...
    <td class="col-sm-5 textwrap">Jelaskan mengapa kapal selam dapat terapung dan tenggelam di air!<div></td>
    <td class="col-sm-5"><div form method="POST" action="postest_fix.php" name="input"></div>
		<textarea name="p1" placeholder="Isikan jawaban"></textarea>
	</td>
</tr>
<tr>
    <td><div align="center">2.</div></td>
    <td class="col-sm-5 textwrap">Adakah perbedaan antara kerapatan relatif benda yang tercelup sebagian dengan kerapatan relatif benda yang tercelup seluruhnya? Mengapa hal tersebut dapat terjadi?<div></td>
    <td class="col-sm-5"><div form method="POST" action="postest_fix.php" name="input"></div>
...
<tr>
    ...
    <td class="col-sm-5 textwrap">Sebenarnya, mengapa kita perlu untuk menentukan kerapatan dan bobot jenis suatu larutan atau dengan kata lain apa manfaat yang diperoleh dengan mengetahui kerapatan dan bobot jenis suatu larutan?<div></td>
    <td class="col-sm-5"><div form method="POST" action="postest_fix.php" name="input"></div>
...
<tr>
    ...
    <td class="col-sm-5 textwrap">Apa perbedaan mendasar antara kerapatan dan bobot jenis?<div></td>
    <td class="col-sm-5"><div form method="POST" action="postest_fix.php" name="input"></div>
...
<tr>
    ...
    <td class="col-sm-5 textwrap">Berikan kesimpulan dari percobaan yang telah dilakukan!<div></td>
    <td class="col-sm-5"><div form method="POST" action="postest_fix.php" name="input"></div>
...
mysqli_select_db($koneksi,$database);	
	  if (isset($_POST['nama'])&&isset($_POST['nimkelas'])&&isset($_POST['materipraktikum'])&&isset($_POST['semester'])&&isset($_POST['p1'])&&isset($_POST['p2'])&&isset($_POST['p3'])&&isset($_POST['p4'])&&isset($_POST['p5']))
	  {
		...
		$sql= "INSERT INTO postest_kerapatan(nama,nimkelas,materipraktikum,semester,p1,p2,p3,p4,p5)VALUES('$nama','$nimkelas','$materipraktikum','$semester','$p1','$p2','$p3','$p4','$p5')";

		if (mysqli_query($koneksi, $sql)){
			echo'<script language="javascript">alert("Terima kasih, data Anda berhasil disimpan");document.location="postest_fix.php";</script>';
		}
		else
		{
